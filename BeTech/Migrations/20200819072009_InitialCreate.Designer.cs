...
namespace BeTech.Migrations
{
    ...
    [Migration("20200819072009_InitialCreate")]
            ...
            modelBuilder.Entity("BeTech.Models.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsBaseCurrency = true,
                            Rate = 1m,
                            UpdateTime = new DateTime(2020, 8, 19, 10, 20, 8, 863, DateTimeKind.Local).AddTicks(1754)
                        },
                        new
                        {
                            CurrencyType = 1,
                            ...
                            Rate = 1m,
                            UpdateTime = new DateTime(2020, 8, 19, 10, 20, 8, 865, DateTimeKind.Local).AddTicks(1754)
                        },
                        new
                        {
                            CurrencyType = 2,
                            ...
                            IsBaseCurrency = false,
                            Rate = 1m,
                            UpdateTime = new DateTime(2020, 8, 19, 10, 20, 8, 866, DateTimeKind.Local).AddTicks(1754)
                        });
                });
