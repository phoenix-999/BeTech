...
namespace BeTech.Migrations
{
    ...
    [Migration("20200819072146_Retype1")]
    partial class Retype1
    {
            ...
            modelBuilder.Entity("BeTech.Models.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsBaseCurrency = true,
                            Rate = 1m,
                            UpdateTime = new DateTime(2020, 8, 19, 10, 21, 45, 754, DateTimeKind.Local).AddTicks(1754)
                        },
                        new
                        {
                            CurrencyType = 1,
                            ...
                            Rate = 1m,
                            UpdateTime = new DateTime(2020, 8, 19, 10, 21, 45, 756, DateTimeKind.Local).AddTicks(1754)
                        },
                        new
                        {
                            CurrencyType = 2,
