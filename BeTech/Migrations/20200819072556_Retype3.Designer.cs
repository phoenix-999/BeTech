...
namespace BeTech.Migrations
{
    ...
    [Migration("20200819072556_Retype3")]
    partial class Retype3
    {
            ...
            modelBuilder.Entity("BeTech.Models.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsBaseCurrency = true,
                            Rate = 1m,
                            UpdateTime = new DateTime(2020, 8, 19, 10, 25, 55, 632, DateTimeKind.Local).AddTicks(1754)
                        },
                        new
                        {
                            CurrencyType = 1,
                            ...
                            Rate = 1m,
                            UpdateTime = new DateTime(2020, 8, 19, 10, 25, 55, 635, DateTimeKind.Local).AddTicks(1754)
                        },
                        new
                        {
                            CurrencyType = 2,
