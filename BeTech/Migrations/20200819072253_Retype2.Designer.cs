...
namespace BeTech.Migrations
{
    ...
    [Migration("20200819072253_Retype2")]
    partial class Retype2
    {
            ...
            modelBuilder.Entity("BeTech.Models.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsBaseCurrency = true,
                            Rate = 1m,
                            UpdateTime = new DateTime(2020, 8, 19, 10, 22, 53, 38, DateTimeKind.Local).AddTicks(1754)
                        },
                        new
                        {
                            CurrencyType = 1,
                            ...
                            Rate = 1m,
                            UpdateTime = new DateTime(2020, 8, 19, 10, 22, 53, 40, DateTimeKind.Local).AddTicks(1754)
                        },
                        new
                        {
                            CurrencyType = 2,
